  ...
  const suggestRollNumber = async (classId) => {
    ...
    try {
      ...
      setForm((prev) =>
        prev.rollNumber
          ? prev
          : { ...prev, rollNumber: data.data.nextRollNumber },
      );
    } catch {
...
Alex Williams,alex.williams@example.com,105,${classId},2008-09-08,other,O-,Michael Williams,+1234567894,654 Maple Dr,parent.alex@example.com,student123`;
    ...
    link.setAttribute(
      "download",
      `sample-students-${new Date().toISOString().split("T")[0]}.csv`,
    );
    ...
    <DashboardLayout>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 p-5 shadow-[0_8px_30px_rgb(0,0,0,0.008)] mb-6 grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-6">
        ...
        >
         ...
         <GreenSelect value={genderFilter} onChange={(e) => { setGenderFilter(e.target.value); setPage(1); }}>
          <option value="">All Genders</option>
          <option value="male">Male</option>
          <option value="female">Female</option>
          <option value="other">Other</option>
        </GreenSelect>
              {/* <GreenSelect value={feeStatusFilter} onChange={(e) => { setFeeStatusFilter(e.target.value); setPage(1); }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <GreenSelect
                ...
                onChange={(e) => {
                  setForm({
                    ...
                    rollNumber: editing ? form.rollNumber : "",
                  });
            ...
            <div>
              <label className="label">
                Parent Email (creates parent login)
              </label>
              <input
                type="email"
                className="input-field"
